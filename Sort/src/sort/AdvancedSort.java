...
public class AdvancedSort {
    ...
    // Quick Sort
    public static void quickSort(ArrayList<Employee> list, int n, int low, int up){
        int pivot;
        if (low >= up){
            return;
        }
    ...
    private static int partition(ArrayList<Employee> list, int n, int low, int up){
        int pivot;
        Employee pivotval;
    ...
    // Merge Sort
    private static void merge(ArrayList<Employee> list, int l, int m, int r) 
    { 
    ...
    public static void mergerSort(ArrayList<Employee> list, int l, int r) 
    { 
        if (l < r) 
        { 
